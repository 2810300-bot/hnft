...
const contracts = [
  ...
  { id: 'FT-2026-028', name: '中转站水电费合同', type: '能源', party: '待提取', amount: 0, status: '待核实', endDate: '待提取', paid: 0, balance: 0, dataQuality: 'IMA文件名解析', source: 'IMA知识库', imaMediaId: 'pdf_5466ec66752d38169003699aa971cb1e_9bda10d1458f11a4433ba93f61f442297424059205752436', imaFolder: '服务维保合同' },
...
const overviewStats = {
  ...
  extractedContent: 36,
  filenameParsed: 33,
  confirmedTotalAmount: 440.785, // 万元（含新增打印机0.316万、空压机待确认）
  dataDate: '2026-06-30',
...
const automationRunInfo = {
  "lastScanTime": "2026-06-30 16:32:23",
  "scanResult": {
    "addedCount": 2,
    "deletedCount": 0,
    "modifiedCount": 0,
