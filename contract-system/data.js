...
const contracts = [
  ...
  { id: 'FT-2026-063', name: '污水处理协议(20250701-20260630)', type: '环保处理', party: '待提取', amount: 0, status: '履行中', endDate: '2026-06-30', paid: 0, balance: 0, dataQuality: 'IMA文件名解析', source: 'IMA知识库', imaMediaId: 'pdf_5466ec66752d38169003699aa971cb1e_7a7dddc7c3242ef545270e0cd91c72547424059205752436', imaFolder: '处置运输协议' },
...
const automationRunInfo = {
  "lastScanTime": "2026-06-29 07:51:28",
  "scanResult": {
    "addedCount": 0,
    "deletedCount": 0,
    "modifiedCount": 0,
...
// ========== 自动化运行信息（由引擎自动更新）==========
const automationRunInfo = {
  "lastScanTime": "2026-06-29 07:53:25",
  "scanResult": {
    "addedCount": 0,
    "deletedCount": 0,
    "modifiedCount": 0,
...
// ========== 自动化运行信息（由引擎自动更新）==========
const automationRunInfo = {
  "lastScanTime": "2026-06-29 07:53:51",
  "scanResult": {
    "addedCount": 99,
    "deletedCount": 0,
    "modifiedCount": 0,
